...
import com.company.Controllers.Endpoints.AuthenticatedEndpoints.CustomerEndpoints.MyAccountOptionsEndpoint;
import com.company.Models.ModelTemplates.User;
import com.company.Views.ViewTemplate;

public class MyAccountOptionsViewTemplate implements ViewTemplate {
    @Override
    public String[] body() {
        return new String[]{
