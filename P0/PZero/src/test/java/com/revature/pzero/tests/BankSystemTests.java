...
//		assertNull(testBankSystem.login(validUsername, null));
	...
	public void createNewUserTest() {
		...
		when(mockBank.newUser(new User(-1, "firstName", "lastName", userType, usernameThatIsTaken, password, false), "Customer")).thenReturn(false);
		
		when(mockBank.viewUsernames()).thenReturn(null);
		when(mockBank.newUser(new User(-1, "firstName", "lastName", userType, username, password, false), "Customer")).thenReturn(true);
		
		assertFalse(testBankSystem.createNewUser(null, null, null, null, null));
		assertFalse(testBankSystem.createNewUser(null, null, null, null, password));
		assertFalse(testBankSystem.createNewUser(null, null, null, username, password));
		assertFalse(testBankSystem.createNewUser(null, null, userType, username, password));
		assertFalse(testBankSystem.createNewUser(null, "lastName", userType, username, password));
		assertFalse(testBankSystem.createNewUser("firstName", null, userType, username, password));
		assertFalse(testBankSystem.createNewUser("", "lastName", userType, username, password));
		assertFalse(testBankSystem.createNewUser("firstName", "", userType, username, password));
		assertFalse(testBankSystem.createNewUser("firstName", "lastName",  null, username, password));
		assertFalse(testBankSystem.createNewUser("firstName", "lastName", userType, null, password));
		assertFalse(testBankSystem.createNewUser("firstName", "lastName", userType, username, null));
		assertFalse(testBankSystem.createNewUser("firstName", "lastName", userType, usernameThatIsTaken, password));
		assertTrue(testBankSystem.createNewUser("firstName", "lastName", userType, username, password));
	}
...
//		User u1 = new User(-1, "firstName", "lastName", "Customer", validUsername, validPassword, false);
//		User u2 = new User(-1, "firstName", "lastName", "Customer", invalidUsername, invalidPassword, false);
//		User u3 = new User(-1, "firstName", "lastName", "Customer", validUsername+1, validPassword+1, true);
		...
		when(mockBank.login(validUsername+1, validPassword+1)).thenReturn(new User(-1, "firstName", "lastName", "Customer", validUsername+1, validPassword+1, true)); 
...
//		when(mockBank.viewAccountByAccountId(Integer.MAX_VALUE+1)).thenReturn(null);
